...
Component({
    ...
    methods: {
        updateRight() {
            const t = this;
            wx.createSelectorQuery().in(this).select(".right").boundingClientRect((function (e) {
                t._slideWidth = e.width;
                let i = e.width <= 50 ? e.width : 50;
                t._threshold = t.properties.threshold ? t.properties.threshold : i, t._viewWidth = t.data.width + e.width * (750 / _windowWidth), t.setData({viewWidth: t._viewWidth})
            })).exec()
        }, onTouchStart(t) {
            ...
            this._length > s && (this.setData({
                ...
                popup: !0,
                close: !1
            }), this.onOpenTap()) : i - e < s && i - e > 0 && !0 !== this.data.popup || e - i >= s ? (this.setData({x: 0}), this.onCloseTap()) : e - i < s && e - i > 0 && (this.setData({
                x: -this._slideWidth,
                close: !1
            }), this.onOpenTap()))
        }, onChange(t) {
            !this.data.out && t.detail.x < -this._threshold ? this.setData({out: !0}) : this.data.out && t.detail.x >= -this._threshold && this.setData({out: !1})
        }, onRightTap() {
            this.properties.autoClose && (this.setData({
                popup: !1,
                x: 0
            }), this.onCloseTap()), this.triggerEvent("lintap", "click right", {bubbles: !0, composed: !0})
        }, onOpenTap() {
